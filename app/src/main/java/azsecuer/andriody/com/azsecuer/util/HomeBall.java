 ...
 */
public class HomeBall extends View {
    /**
     * 画笔
     */
    private Paint paint;
    ...
    public HomeBall(Context context) {
        this(context,null);
    }

    public HomeBall(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public HomeBall(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        paint=new Paint();
        /**
         * 初始化属性，如果没取到值给一个默认值
         */
        TypedArray array=context.obtainStyledAttributes(attrs,R.styleable.HomeBall);
        roundColor=array.getColor(R.styleable.HomeBall_roundColor,context.getResources().getColor(R.color.white));
        roundProgressColor=array.getColor(R.styleable.HomeBall_roundProgressColor,context.getResources().getColor(R.color.piechar_phonespace_progressbar_bg));
        textColor=array.getColor(R.styleable.HomeBall_textColor,context.getResources().getColor(R.color.black));
        textSize=array.getDimension(R.styleable.HomeBall_textSize,30);
        roundWidth = array.getDimension(R.styleable.HomeBall_roundWidth,5);
        max = array.getInteger(R.styleable.HomeBall_max,100);
        textDisplayable = array.getBoolean(R.styleable.HomeBall_textDisplayable,true);
        style = array.getInt(R.styleable.HomeBall_style,0);
        array.recycle();// 释放一下
    }
    /**
     *  画出相应的东西
